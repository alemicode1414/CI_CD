...
class ExpressionEvaluatorTest1 {
    ...
    fun `Simple expression properly evaluated`() {
        ...
        val expected = -4.0
        assertEquals(evaluator.evaluate(), expected, 0.000001)
    ...
    fun `Expression with decimals properly evaluated`() {
        ...
        assertEquals(evaluator.evaluate(), 4.5, 0.000001)
    ...
    fun `Simple equation with parentheses properly evaluated`() {
        ...
        assertEquals(evaluator.evaluate(), 6.5, 0.000001)
    }
}